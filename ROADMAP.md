...
| T2.6  | Safe argv spawn                      | todo   |
| T2.7  | Readiness probes                     | todo   |
| T2.8  | Process supervisor + restart policy  | todo   |
| T2.9  | Graceful shutdown                    | todo   |
| T2.10 | ShellContext + plugin registries     | todo   |
| T2.11 | Permission + hardening policy (pure) | todo   |
