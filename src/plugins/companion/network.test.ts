...
describe('network utilities (T4.3)', () => {
  ...
  it('skips virtual adapters in favor of physical ones', () => {
    const mockInterfaces: NetworkInterfaceDirectory = {
      vEthernet: [{ address: '192.168.99.1', family: 'IPv4', internal: false } as NetworkInterfaceInfo],
  ...
  it('handles IPv6 hosts and paths with spaces correctly via URL encoding', () => {
    ...
    // URL builder automatically brackets IPv6 hostname and encodes spaces
